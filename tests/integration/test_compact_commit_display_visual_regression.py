    ...
    def standard_test_forks(self):
        ...
        return [
            ...
            Repository(
                ...
                name="unicode-测试-🚀",
                owner="用户名",
                full_name="用户名/unicode-测试-🚀",
                url="https://api.github.com/repos/用户名/unicode-测试-🚀",
                html_url="https://github.com/用户名/unicode-测试-🚀",
                clone_url="https://github.com/用户名/unicode-测试-🚀.git",
