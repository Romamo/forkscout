...
from forklift.models.analysis import CommitExplanation, CommitCategory, ImpactAssessment, CategoryType, ImpactLevel, MainRepoValue
...
class TestCLIEnhancedExplanations:
    ...
    def test_display_commit_explanations_uses_formatter(self, mock_formatter_class):
        ...
        from forklift.cli import display_commit_explanations
        from forklift.models.analysis import ForkAnalysis, CommitExplanation
